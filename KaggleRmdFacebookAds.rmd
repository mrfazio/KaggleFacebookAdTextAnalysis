...
vector_msg_clean %>% get_df_words_freq %>% datatable
```
...
wordcloud_political <- wordcloud(df_political_msgs_freq$Word, df_political_msgs_freq$Frequency)
wordcloud_not_political <- wordcloud(df_not_political_msgs_freq$Word, df_not_political_msgs_freq$Frequency)

grid.arrange(wordcloud_political, wordcloud_not_political, ncol = 2)
```
