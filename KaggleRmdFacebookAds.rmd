...
Também podemos utilizar uma outra análise por meio da métrica de centralidade betweeness para analisar quais entidades se conectam aos outros grupos relacionados a outras entidades.
...
Aqui, notamos um elevado número de termos, nomes, regiões e locais de natureza latina ou relacionados ao sul dos EUA. Então, aparentemente, indivíduos (como atores e artistas) e organizações relacionadas a esses elementos tendem a, por alguma razão, serem ativos na disseminação de propagandas não políticas do Facebook.
...
Iremos traçar o grafo de ego relacionado a "Donal Trump" com base no grafo geral criado na seção anterior. Efetuando os ajustes necessários no Gephi, obtemos:
